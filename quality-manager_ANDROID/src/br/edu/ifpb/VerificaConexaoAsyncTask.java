...
import br.edu.ifpb.util.HttpUtil;
...
public class VerificaConexaoAsyncTask extends
		AsyncTask<Void, Integer, JSONObject> {

	private Activity activity;

	public VerificaConexaoAsyncTask(Activity activity) {
	...
	protected void onPostExecute(JSONObject result) {
		...
		try {
			...
			if (online) {
				...
				Intent intent = new Intent(activity, MenuAplicacaoActivity.class);

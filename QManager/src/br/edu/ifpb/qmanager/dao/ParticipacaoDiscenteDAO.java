...
public class ParticipacaoDiscenteDAO implements GenericDAO<Integer, Participacao<Discente>> {

	// a conexão com o banco de dados
	public Connection connection;
	private DatabaseConnection banco;

	public ParticipacaoDiscenteDAO(DatabaseConnection banco) {
		this.connection = (Connection) banco.getConnection();
		this.banco = banco;
	}

	@Override
	public Participacao<Discente> getById(Integer id) throws QManagerSQLException {

		Participacao<Discente> participacao = null;
		...
		try {
			...
			List<Participacao<Discente>> participacoes = convertToList(rs);
	...
	@Override
	public int insert(Participacao<Discente> participacao) throws QManagerSQLException {
	...
	@Override
	public void update(Participacao<Discente> participacao) throws QManagerSQLException {
	...
	@Override
	public List<Participacao<Discente>> findAll() throws QManagerSQLException {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<Participacao<Discente>> convertToList(ResultSet rs)
			throws QManagerSQLException {

		List<Participacao<Discente>> participacoes = new ArrayList<Participacao<Discente>>();

		Participacao<Discente> participacao = new Participacao<Discente>();
		DiscenteDAO pessoaDAO = new DiscenteDAO(banco);
		ProjetoDAO projetoDAO = new ProjetoDAO(banco);

		try {

			while (rs.next()) {
				Discente pessoa = pessoaDAO.getById(rs.getInt("pessoa_id"));

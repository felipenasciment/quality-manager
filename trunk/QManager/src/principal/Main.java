...
public class Main {
	...
	private static void insertTest(Banco banco) {
		...
		try {
			...
			DadosBancarios contaDocente = new DadosBancarios(null, "22315",
					"001", "123456");
			Docente docente = new Docente("Rhavy Maia Guedes", "1234578900",
					"23490912309", "Rua das Laranjeiras", "58123456",
					"33337777", "rhavymg@gmail.com", "Mestre", "Professor",
					"Campina Grande", usuarioDocente, contaDocente);
			...
			System.err.println("Erro número: " + qme.getErrorCode() + ": "
					+ qme.getMessage());
		}

...
public class EditalExtençãoDAO {
	...
	// Adicinando um novo Edital de Extenção ao banco
		public void adiciona(EditalExtensão edital) {
			...
			String sql = "INSERT INTO editalextensão (N_ANO, Inicio_das_inscrições, Fim_das_escrições,"
					+ " Ano, Prazo_do_relatório_parcial, Prazo_do_relatório_final, Número_de_vagas,"
					+ " Valor_bolsa_docente, Valor_bolsa_discente, PIE_Id_Programa)"
					+ " values (?,?,?,?,?,?,?,?,?,?)";
		...
		public void alterar(EditalExtensão edital) {
			...
			String sql = "UPDATE editalextensão SET Inicio_das_inscrições=?, Fim_das_escrições=?, Ano=?, Prazo_do_relatório_parcial=?,"
					+ " Prazo_do_relatório_final=?, Número_de_vagas=?, Valor_bolsa_docente=?, Valor_bolsa_discente=?,"

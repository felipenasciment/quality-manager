...
public class ProjetoExtensão {
	 ...
	 * projeto de pesquisa.
	 */
	public ProjetoExtensão(String iD_projeto, String nomeProjeto, String dataInício, String dataTérmino, String anoProjeto,
			String relatórioParcial, String relatórioFinal, String processo,
			String registro, String anoN) throws ParseException {

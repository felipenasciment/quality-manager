...
public class QManagerMapErro {
	...
	static {
		...
		erros.put(QManagerCodeErro.CPF_INVALIDO, "CPF inválido!");
		erros.put(QManagerCodeErro.MATRICULA_INVALIDA, "Matrícula inválida!");
		erros.put(QManagerCodeErro.ENDERECO_INVALIDO, "Endereco inválido!");
		erros.put(QManagerCodeErro.CEP_INVALIDO, "CEP inválido!");
		erros.put(QManagerCodeErro.TELEFONE_INVALIDO, "Telefone inválido!");
		erros.put(QManagerCodeErro.EMAIL_INVALIDO, "E-mail inválido!");
		...
		// Docente
		erros.put(QManagerCodeErro.TITULACAO_INVALIDA, "Titulação inválida!");

...
public class ParserAsyncTask<E> extends
	...
	public ParserAsyncTask(E entidade, Activity activity,
			String path, int IdCoordenador) {
	...
	protected void onPostExecute(JSONObject result) {
		pDialog.dismiss();
		String mensagem = "Instituição Financiadora Cadastrada com Sucesso!";
		Toast toast = Toast.makeText(activity.getApplicationContext(),
				mensagem, Toast.LENGTH_SHORT);
		toast.show();
		Intent intent = new Intent(activity, GestorActivity.class);
		Bundle params = new Bundle();
		params.putInt("Coordenador", IdCoordenador);
